...
const Table = () => {
    ...
    const handleApprove = (rowInd, row) => {
        ...
        alert("Is Chiken Breast Fillets,Boneless...'urgent?")
    };
    ...
    const columns = [
        ...
        { field: 'status', name: 'Status' },
        {
            ...
            sort: false,
            search: false,
            cellTemplate: (row,  rowInd, handleApprove, handleMissing) => {
                return (
    ...
    return (
        <TableContainer component={Paper}>
            <MuiTable sx={{ minWidth: 400, maxHeight: '120%' }} aria-label='simple table'>
                <TableHead>
                    <TableRow>
                        {_map(columns, column => {
